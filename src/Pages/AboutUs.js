...
function AboutUs(props) {
    return (
        <div className={'w-full h-screen px-5 lg:px-32 text-center lg:mt-0 mt-96'}>
            <h1 data-aos='fade-down' className={'text-5xl pt-32 lg:pt-0 font-bold'}>Qulayliklar</h1>
            <p data-aos='zoom-out' className={'w-full lg:w-6/12  m-auto text-gray-400 mt-5 lg:mt-10'}>SAFO MED bilan sog‘liqni saqlash bo‘yicha sayohatingiz muammosiz. Tanlangan xizmatlarni davom ettirish uchun quyida keltirilgan amallarni bajaring. Qo'shimcha yo'l-yo'riqlar uchun FAQ bo'limimizni ham ko'rishingiz mumkin:</p>
            <div className={'lg:flex'}  style={{height:'90vh'}}>
                <div className={'w-1/2 h-full lg:pt-20 relative'}>
                    <div style={{height: '60vh'}}
                         className={'border-l-2 w-1/3 border-dashed border-blue-400 absolute lg:left-40 left-14 lg:top-20  top-10 '}>
                        <div id={'background'}
                    ...
                    <div data-aos='zoom-out' className={'lg:w-96 w-60 absolute lg:left-60 lg:top-24 left-28 top-12'}>
                    ...
                    <div data-aos='zoom-out' className={'lg:w-96 w-60 absolute  lg:left-60 lg:bottom-3 left-28 -bottom-10cmd'}>
                ...
                <div data-aos='zoom-out' className={'w-1/2 h-full relative'}>
                    <div
